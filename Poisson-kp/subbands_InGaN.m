...
ylabel('Energy, eV')
title('GaN/InGaN/GaN:C-subbands')
%==========================================================================
figure(2),   hold on
plot(kgrid,SB2(1,:), 'k.')%
plot(kgrid,SB2(2,:), 'k.')%
...
xlabel('kx, inplane kvectors')
ylabel('Energy, eV')
title('GaN/InGaN/GaN:V-subbands')
%==========================================================================
save subbands_InGaN_201 XV1 XV2 SB1 SB2 kgrid mesh
%==========================================================================